...
import { LiftDto, SavedLiftsDto, UserTrackedLiftDto } from '@/db/data-access/dto/lifts/types';
import { UserInformationDto } from '@/db/data-access/dto/users/types';
import { getBenchmarkLiftsByUserId, getNoneBenchmarkLifts, getUserTrackedLiftsByUserId } from '@/db/data-access/lifts';
import { getAuthenticatedUserId, getUserInformation } from '@/db/data-access/users';

async function LiftsPage() {
    const userId = await getAuthenticatedUserId();

    const benchmarkLifts: SavedLiftsDto[] = await getBenchmarkLiftsByUserId(userId);

    const userTrackedLifts: UserTrackedLiftDto[] = await getUserTrackedLiftsByUserId(userId);
        ...
        <section className="container mx-auto pt-8 pb-24">
            <div className="flex flex-col gap-6">
                ...
                <p className="text-sm text-muted-foreground">
                    This section will allow you to track your lifts progression and maximum weights.
                </p>
