  ...
  return (
    <div className='container mx-auto pt-8 pb-24'>
      <div className='grid gap-6'>
        <div className='grid gap-6'>
          <h1 className='text-3xl font-bold text-violet-300'>Account</h1>
        ...
        <div className='flex flex-col gap-2'>
          <h2 className='text-lg font-bold'>Competitive Division</h2>
          {userInformations.birthYear <= MINIMUM_MASTER_BIRTH_YEAR ? (
            <DivisionRadioGroup
              value={userInformations.division}
              labels={[
                ["senior", "Senior"],
                ["master", "Master"],
              ]}
            ...
            <div className='flex flex-col gap-6 bg-gradient-to-b from-neutral-800 p-4 rounded-xl w-full font-semibold'>
              {userInformations.division[0].toUpperCase()}
              {userInformations.division.slice(1)}
            </div>
          )}
        </div>
