  ...
  return (
    <section className="container mx-auto pt-8 pb-24">
      <div className="flex flex-col gap-8">
        ...
        <LiftList lifts={benchmarkLifts} category="Main Lift" title="Main Lifts" weightPreference={userInformations.liftsUnit} />
        <LiftList lifts={benchmarkLifts} category="Accessory Lift" title="Accessory Lifts" weightPreference={userInformations.liftsUnit} />
      </div>
    </section>
  );
}
