...
export function RestTimerView({ completedSet, totalSets, currentBlock, onComplete }: RestTimerViewProps) {
    const { data: settings } = useTrainingSettings();
    const defaultDuration = settings?.defaultRestSeconds ?? 120;
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-4">
            ...
            <div className="mb-8 text-center">
                ...
                <p className="mt-1 text-xs text-muted-foreground/60">
                    Set {completedSet}/{totalSets} complete &middot; Block{' '}
                    {'ABCDEFGHIJKLMNOPQRSTUVWXYZ'[currentBlock] ?? currentBlock + 1}
                </p>
            </div>
            ...
            <div className="relative flex items-center justify-center">
                ...
                <div className="absolute flex flex-col items-center">
                    ...
                    {remaining === 0 && <span className="mt-1 text-sm font-medium text-green-500">Go!</span>}
                </div>
            </div>
