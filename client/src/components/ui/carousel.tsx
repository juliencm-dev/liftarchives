...
function CarouselDots({ className }: { className?: string }) {
    ...
    return (
        <div className={cn('flex items-center justify-center gap-2 pt-3', className)} role="tablist">
            {Array.from({ length: snapCount }).map((_, i) => (
                <button
                    ...
                    className={cn(
                        ...
                        i === selectedSnap ? 'bg-primary' : 'border border-muted-foreground/60 bg-transparent'
                    )}
